...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        return view('author.profile.index',compact('user','posts','comments','favorites'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image')){
            $old_image_path = base_path('public/upload/users/'.$user->profile_photo_path);
    ...
    {
        $user = Auth::user();
        return view('author.profile.setting',compact('user'));
    }
