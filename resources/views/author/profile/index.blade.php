                    ...
                    <div class="card">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-content">
                                                ...
                                                <div class="box bg-light-info">
                                                    ...
                                                    <a href="{{ route('author.post.edit',$post->slug) }}" class="btn text-secondary btn-sm  btn-outline-primary"><i class="ik ik-edit-2"></i></a>
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-content">
                                                ...
                                                <div class="box bg-light-info">{!! Str::words($comment->comment,10,'....') !!}</div>
                                                <a href="{{ route('author.post.edit',$post->slug) }}" class="btn text-secondary btn-sm  btn-outline-primary"><i class="ik ik-edit-2"></i></a>

                                                <button onclick="deleteComment({{$comment->id}})" class="btn btn-outline-danger btn-sm"><i class="ik ik-trash-2"></i></button>
                                                <form style="display: none;" id="delete-comment-{{ $comment->id }}" action="{{ route('author.comment.destroy',$comment->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
                                        ...
                                        <li class="chat-item">
                                            ...
                                            <div class="chat-content">
                                                ...
                                                <div class="box bg-light-info">
                                                    ...
                                                    <form style="display: none;" id="delete-favorite-{{ $favorite->id }}" action="{{ route('author.favorite.destroy',$favorite->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </div>
                            ...
                            <div class="tab-pane fade" id="previous-month" role="tabpanel" aria-labelledby="pills-setting-tab">
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{ route('author.profile.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
