...
@section('content')
    <div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url({{ asset('frontend') }}/assets/img/bg/page3.jpg); background-position: right">
        <div class="container-fluid">
            <div class="breadcrumb-content text-center">
                <h2>{{ \Illuminate\Support\Str::title($tag->name) }}</h2>
                <ul>
